...
if(isset($_GET['edit_account'])){
    ...
    $username=$row_fetch['username'];//value present in db table
    $user_email=$row_fetch['user_email'];
}
    if(isset($_POST['user_update'])){
        $update_id=$user_id;
        $username=$_POST['user_username'];//name attribute of username
        ...
        //update query
        $update_data="update `user_table` set username='$username',user_email='$user_email',user_image='$user_image' where user_id=$update_id";
