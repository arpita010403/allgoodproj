...
<div class="container mt-3">
    ...
    <form action="" method="post" class="text-center">
        <div class="form-outline mb-4">
            ...
            <input type="text" name="category_title" id="category_title" class="form-control w-50 m-auto" required="required" value="<?php echo $category_title;?>">
        </div>
        <input type="submit" value="Update Category" class="btn btn-secondary text-light px-3 mb-3" name="edit_cat">
    </form>
</div>
